  ...
  const categories = [
    {
      ...
      count: '180+ моделей',
      description: 'Седаны, хэтчбеки, универсалы для всей семьи',
    ...
    },
    {
      ...
      count: '120+ моделей',
      description: 'SUV для города и бездорожья',
    ...
    },
    {
      ...
      count: '50+ моделей',
      description: 'Грузовики, фургоны для бизнеса',
      color: 'from-orange-500 to-orange-600',
    },
    {
      icon: Zap,
      title: 'Спортивные авто',
      count: '30+ моделей',
      description: 'Для ценителей скорости и стиля',
    ...
    },
    {
      ...
      title: 'Электромобили',
      count: '40+ моделей',
      description: 'Экологичный транспорт будущего',
      color: 'from-teal-500 to-teal-600',
    },
    {
      icon: Users,
      title: 'Семейные минивэны',
      count: '25+ моделей',
      description: 'Комфорт для всей семьи',
    ...
    },
    {
      ...
      count: '200+ моделей',
      description: 'Проверенные автомобили с гарантией',
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {categories.map((category, index) => (
            <a
              key={index}
              href="#cars"
              className="group card p-6 hover:cursor-pointer"
            >
